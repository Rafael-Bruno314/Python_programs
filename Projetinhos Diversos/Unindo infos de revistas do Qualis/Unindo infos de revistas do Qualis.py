...
file= os.path.join(os.path.dirname(__file__), 'Ciências Biológicas I, Educação e Engenharias II.xlsx') 
...
#df_agrupado.to_csv((os.path.join(os.path.dirname(__file__),'Lista completa.txt')), sep='\t', index=False, encoding='utf-8')
...
df.to_csv((os.path.join(os.path.dirname(__file__),'Lista - Seleção Específica.txt')), sep='\t', index=False, encoding='utf-8')
